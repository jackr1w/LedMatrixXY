...
namespace ledmatrixxy {
    ...
    //% weight=80
    //% parts="ledmatrixxy"
    export function setPixel(matrix: LEDMatrix, x: number, y: number, rgb: number): void {
    ...
    //% weight=76
    //% parts="ledmatrixxy"
    export function clear(matrix: LEDMatrix): void {
        matrix.clear()
    }
    ...
    //% weight=79
    //% parts="ledmatrixxy"
    export function show(matrix: LEDMatrix): void {
        matrix.show()
    }
...
namespace ledmatrixlegacy {
    ...
    export class Strip {
        ...
        showBarGraph(value: number, high: number): void {
            if (high <= 0) {
                this.clear();
                this.setPixelColor(0, LedMatrixXYColors.Yellow);
                this.show();
                return;
            }
        ...
        /**
         * For LedMatrixXYs with RGB+W LEDs, set the white LED brightness. This only works for RGB+W LedMatrixXYs.
        ...
        private setBufferRGB(offset: number, red: number, green: number, blue: number): void {
            if (this._mode === LedMatrixXYMode.RGB_RGB) {
        ...
        private setPixelRGB(pixeloffset: number, rgb: number): void {
            ...
            let stride = this._mode === LedMatrixXYMode.RGBW ? 4 : 3;
    ...
    export function create(pin: DigitalPin, numleds: number = 64, mode: LedMatrixXYMode): Strip {
        ...
        strip._mode = mode || LedMatrixXYMode.RGB;
